...
<script type="text/javascript" src="layout/js/nav_bar_script.js?v=20260709"></script>
 <div class="navbar navbar-default" role="navigation" style="position: auto; border-width: 0px 0px 1px 0px; border-color: rgba(0,0,0,0.2); padding: 10px;" >
        ...
        <ul class="nav navbar-nav navbar-left">  
          ...
          <span class="nev_bar_button_area">
             <!-- here button -->
           <button onclick="student_info_nav_bar()" class="btn_tab" style="margin-left: 15px;"><span class="glyphicon glyphicon-fire"></span> Learner Quick Access</button>
