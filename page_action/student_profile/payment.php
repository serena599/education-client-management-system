...
<table width="100%">
   ...
   ?>
    ...
    <td class="td_list2"><?php echo "$year"; ?></td>
		<td class="td_list2"><?php echo 'AUD $'.$pay; ?></td>
               ...
               <div class="col-md-7">
                  ...
                  <table width="100%">
                   ...
                   <tr>
                    ...
                    <td class="td_profile2"><?php echo 'AUD $<b>'.$fee.'</b>' ?></td>
                  </tr>
                  <tr>
                    <td class="td_profile1 td_fee">Total Pay:</td>
                    <td class="td_profile2"><?php echo 'AUD $<b>'.$total_pay.'</b>' ?></td>
                  </tr>
                  <tr>
                    <td class="td_profile1 td_fee">Total Due:</td>
                    <td class="td_profile2"><?php echo 'AUD $<b>'.$due.'</b>' ?></td>
                  </tr>
                  <tr>
