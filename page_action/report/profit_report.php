...
<table width="100%">
	...
	<tr>
		...
		<td class="td2">AUD $<?php echo $info['total_payment']; ?></td>
	</tr>
	<tr>
		<td class="td2">Total Expense</td>
		<td class="td2">AUD $<?php echo $info['total_expence']; ?></td>
	</tr>
	<tr>
		<td class="td2">Total Income</td>
		<td class="td2">AUD $<?php echo $info['total_income']; ?></td>
	</tr>
	<tr>
		<td class="" style="font-size: 15px;text-align: right; padding-right: 10px"><b>Total Profit</b></td>
		<td class="td2"><b style="font-size: 15px;">AUD $<?php echo $info['total_profit']; ?></b></td>
	</tr>
