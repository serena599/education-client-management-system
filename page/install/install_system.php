...
<div class="container" style="padding: 10px;margin-top: 5px;">
                <div class="row register" style="padding: 5px;">
                    <div class="col-md-4 col-sm-12 register-left">
                        ...
                        <b style="font-size: 13px;">Project</b><br/>
                        <b style="font-size: 25px;">Education Client Management System</b><br/>
                        By <b style="font-size: 16px;"><a href="https://github.com/serena599" style="color: #ffffff">Serena</a></b>
                        ...
                        <a href="https://github.com/serena599"><input type="submit" name="" value="Github"/></a><br/>
                    </div>
