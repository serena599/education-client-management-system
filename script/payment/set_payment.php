     ...
     <div class='right_body'>
      <table>
        <tr>
          ...
          <td class='td_value'>AUD $<?php echo $info['total_fee']; ?></td>
        </tr>
        <tr>
          <td class='td_name'>Previous Total Pay: </td>
          <td class='td_value'>AUD $<?php echo $info['total_pay']; ?></td>
        </tr>
        
        <tr>
          <td class='td_name'>Pay: </td>
          <td class='td_value'>AUD $<?php echo $info['pay']; ?></td>
        </tr>
        <tr>
          <td class='td_name'>Total Due: </td>
          <td class='td_value'>AUD $<?php echo $info['due']; ?></td>
        </tr>
        <tr>
